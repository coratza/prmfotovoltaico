      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-14 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="tel:+393356117388" onClick={() => trackPhoneCall("header_desktop")} className="flex items-center gap-2 text-primary font-semibold hover:text-primary/80 transition-colors">
          ...
          <nav className="lg:hidden py-3 border-t border-border animate-fade-in">
            ...
            <div className="mt-3 pt-3 border-t border-border">
              <Button variant="cta" size="lg" className="w-full rounded-full" asChild>
                <a href="tel:+393356117388" onClick={() => trackPhoneCall("header_mobile_menu")}>
