        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="blue-card">
            <div className="flex flex-col gap-4 md:gap-6">
              <div className="overflow-hidden rounded-2xl h-48 sm:h-56">
                <img src={villaSolar} alt="Fotovoltaico per privati" className="w-full h-full object-cover" width="533" height="300" loading="lazy" />
              </div>
              <div>
                <h3 className="text-xl sm:text-2xl font-heading font-normal text-primary-foreground mb-2 md:mb-3">
                  Per Privati
                </h3>
                ...
                <Button variant="outline" className="rounded-full border-primary-foreground/50 text-primary-foreground hover:bg-primary-foreground/10 bg-transparent text-sm" asChild>
